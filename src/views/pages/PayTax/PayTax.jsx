...
const CreateInvoice = () => {
    ...
    const handlePayTaxSubmit = async () => {
        try {
            const token = JWTManager.getToken();
            const response = await fetch(`${config.api_url}/pay-tax`, {
                method: "POST",
                headers: {
                    "Content-Type": "application/json",
                    "Authorization": `${token}`
            ...
            <div className="create-organization content">
                ...
                <Row>
                    <Col lg="12">
                        <Card>
                            <CardHeader>
                                <CardTitle tag="h4">Pay Tax</CardTitle>
                            </CardHeader>
                            <CardBody>
                                <Form action="#">
...
//                 headers: {
//                     "Content-Type": "application/json",
//                     "Authorization": `${JWTManager.getToken()}`, // Ensure proper authorization format
//                 },
//             });
